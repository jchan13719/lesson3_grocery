			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"grocery-display": {
								"semanticObject": "grocery",
								"action": "display",
								"description": "A Fiori application for a grocery store.",
								"title": "Dashboard",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=grocery",
									"url": sap.ui.require.toUrl("grocery")
								}
							}
						}
					}
